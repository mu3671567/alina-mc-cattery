...
const cats = [
    ...
    },
    {
        ...
        gender: "Male",
        color: "Black Smoke",
        description: "Playful black smoke male with excellent temperament",
        status: "available",
        image: "🦁"
    },
    {
        ...
        gender: "Female",
        color: "Blue Tabby",
        description: "Rare blue tabby female with magnificent ruff",
        status: "available",
        image: "🐱"
    }
];
...
window.addEventListener('scroll', function() {
    ...
    if (window.scrollY > 100) {
        ...
        navbar.style.boxShadow = '0 5px 20px rgba(139, 69, 19, 0.15)';
    } else {
